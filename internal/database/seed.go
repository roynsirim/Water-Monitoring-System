...
func SeedMeters() []models.Meter {
	return []models.Meter{
		...
		{ID: "s-rms2", SiteID: models.SiteStocksbridge, Department: models.DeptRemelt, Name: "RMS 2", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-vim", SiteID: models.SiteStocksbridge, Department: models.DeptRemelt, Name: "VIM", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-bm16", SiteID: models.SiteStocksbridge, Department: models.DeptBilletMill, Name: "BM Meter 16", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-bm17", SiteID: models.SiteStocksbridge, Department: models.DeptBilletMill, Name: "BM Meter 17", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-bms14", SiteID: models.SiteStocksbridge, Department: models.DeptBilletMill, Name: "BM Saws Meter 14", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-croft", SiteID: models.SiteStocksbridge, Department: models.DeptCroft, Name: "Croft Supply", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		// River Water
		{ID: "s-wq1", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "Water Quench 1", WaterType: models.RiverWater, Feed: "West Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-wq2", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "Water Quench 2", WaterType: models.RiverWater, Feed: "West Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-sb", SiteID: models.SiteStocksbridge, Department: models.DeptSpringBank, Name: "Spring Bank", WaterType: models.RiverWater, Feed: "Spring Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		// Manual meters
		{ID: "s-wbwa", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "West Bank Water Abstraction Meter", WaterType: models.RiverWater, Feed: "West Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-wbw", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "West Bank Water", WaterType: models.RiverWater, Feed: "West Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-wbg", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "West Bank Gardens", WaterType: models.RiverWater, Feed: "West Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-g2", SiteID: models.SiteStocksbridge, Department: models.DeptGeneral, Name: "No.2 Gate Meter", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-g1", SiteID: models.SiteStocksbridge, Department: models.DeptGeneral, Name: "No.1 Gate (Hawthorne Brook)", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-ebte", SiteID: models.SiteStocksbridge, Department: models.DeptEastBank, Name: "EB Trade Effluent", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-ebn", SiteID: models.SiteStocksbridge, Department: models.DeptEastBank, Name: "EB Network", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "s-ebt", SiteID: models.SiteStocksbridge, Department: models.DeptEastBank, Name: "EB Tank Meter", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceManual, Unit: "m3", IsActive: true, IsMainMeter: true},
		// Other EEmon
		{ID: "s-wboq", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "West Bank Oil Quench", WaterType: models.TownsWater, Feed: "West Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-wbcht", SiteID: models.SiteStocksbridge, Department: models.DeptWestBank, Name: "West Bank CHT", WaterType: models.TownsWater, Feed: "West Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-bbr", SiteID: models.SiteStocksbridge, Department: models.DeptBilletMill, Name: "Billet Bank Reeler", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		{ID: "s-esr1", SiteID: models.SiteStocksbridge, Department: models.DeptEastBank, Name: "ESR 1", WaterType: models.TownsWater, Feed: "East Bank", Source: models.SourceEEmon, Unit: "litres", IsActive: true, IsMainMeter: true},
		...
		{ID: "b-hmr", SiteID: models.SiteBrinsworth, Department: models.DeptHotMill, Name: "Hot Mill River Water Meter", WaterType: models.RiverWater, Feed: "River", Source: models.SourceTrend, Unit: "m3", IsActive: true, IsMainMeter: true},
		{ID: "b-hrp", SiteID: models.SiteBrinsworth, Department: models.DeptHRP, Name: "HRP River Water Meter", WaterType: models.RiverWater, Feed: "River", Source: models.SourceTrend, Unit: "m3", IsActive: true, IsMainMeter: true},
